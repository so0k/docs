...
When you write constructs in the same language as your CDKTN application, you can use the same importing mechanisms you use with other applications. Refer to [Constructs](/docs/concepts/constructs) in the CDKTN Concepts documentation for more details about using constructs.
