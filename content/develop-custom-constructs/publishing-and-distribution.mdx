...
You can write a CDKTN construct class and then synthesize the code into an HCL [Terraform module](https://developer.hashicorp.com/terraform/language/modules). When you use this approach, you are limited to the structure and functionality available in a Terraform module. For example, you cannot use enums or methods to provide advanced configuration options.
