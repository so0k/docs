...
<Tip>Try our [Get Started - HCP Terraform](https://developer.hashicorp.com/terraform/tutorials/cloud-get-started) tutorials.</Tip>
...
2. Use the `TerraformVariable` construct to declare variables in your CDKTN application. This creates an undefined [Terraform input variable](https://developer.hashicorp.com/terraform/language/values/variables). The following example demonstrates how to create a `TerraformVariable` called `my-var`.
