...
Add the `--local` flag to created a scaffolded project that is pre-configured to use a [local backend](https://developer.hashicorp.com/terraform/language/settings/backends/local). This means that your application stores [Terraform state](https://developer.hashicorp.com/terraform/language/state) on your local machine and all Terraform operations run locally.
