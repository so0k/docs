...
We recommend using [CDKTN CLI commands](/docs/cli-reference/commands) in the following use cases:
...
Refer to [Set Up CDKTN With HCP Terraform](/docs/create-and-deploy/hcp-terraform#set-up-cdktn-with-hcp-terraform) for details. Refer to [Example Workflows](#example-workflows) for several examples of connecting your CDKTN application to HCP Terraform and using HCP Terraform in a Continuous Integration pipeline.

## Managing Secrets and Sensitive Data

You should [read secrets with Terraform Variables](/docs/create-and-deploy/best-practices#read-secrets-with-terraform-variables) so that they do not appear in your synthesized CDKTN code.
