...
<Tip>CDKTN works with both Terraform and OpenTofu. To run OpenTofu, set `TERRAFORM_BINARY_NAME=tofu` before using the CLI. Refer to [Environment Variables](/docs/create-and-deploy/environment-variables) for details.</Tip>
...
- Review how CDKTN works with Terraform [providers](/docs/concepts/providers) and [stacks](/docs/concepts/stacks).
